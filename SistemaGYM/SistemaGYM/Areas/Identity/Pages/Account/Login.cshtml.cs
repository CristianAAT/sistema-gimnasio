...
namespace SistemaGYM.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //agregamos el login por identity user ya que el mismo si me deja acceder a los usuarios creados manualmente
                IdentityUser user = await _userManager.FindByEmailAsync(Input.Email);
                Microsoft.AspNetCore.Identity.SignInResult result;

                if (Input.Email.Contains('@') || user != null)
                {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Usuario o contraseña invalido/s.");
                    return Page();
                }
            }
